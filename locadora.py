...
def mostrarlistaCarros(lista_de_carros):
...
while True:
  ...
  if op == 0:
    ...
    print("0 para aluguel totalizaria R$ {}. Deseja alugar?".format(dias * carros[cod_car][1]))
